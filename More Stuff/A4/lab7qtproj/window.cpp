...
void Window::changeLightx(int val)
{
    m_glWidget->lightposn.setX(val);
//    m_glWidget->makeImage();
}

void Window::changeLighty(int val)
{
    m_glWidget->lightposn.setY(val);
//    m_glWidget->makeImage();
}

void Window::changeLightz(int val)
{
    m_glWidget->lightposn.setZ(val);
//    m_glWidget->makeImage();
}
