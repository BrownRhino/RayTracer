...
#include <QtOpenGL>
#include <math.h>
#include "ray.h"    //Contains class declaration which is used to build rays
#include "sphere.h" //Contains class declaration which is used to build spheres
#include "scene.h"  //Contains class declaration which is used to make scenes
#include <QDebug>
